...
module.exports = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var channelID, userUID, dbNum, colo, colr;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        if (!((_b.sent()) >= 1)) return [3 /*break*/, 5];
                        return [4 /*yield*/, reporterSchema_1["default"].findOne({ userId: userUID })];
                    case 3:
                        colo = _b.sent();
                        colr = colo.col;
                        return [4 /*yield*/, new reportSchema_1["default"]({
                                _id: dbNum,
                                userIden: [],
                    ...
                    case 4:
                        _b.sent();
                        channelID.send("Your report was made with the ID ".concat(dbNum, "."));
                        _b.label = 5;
