    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, reporterSchema_1["default"].countDocuments({ userId: message.author.id })];
                    case 1:
                        if (!((_b.sent()) >= 1)) return [3 /*break*/, 10];
                        type = (args[0]);
                        bans = [];
                        addNum = 0;
                        if (args[0] === 'mass') {
                    ...
                    case 7:
                        i++;
                        return [3 /*break*/, 2];
                    case 8: return [4 /*yield*/, message.reply("Successfully added ".concat(setS, " users to the database with ").concat(counted, " already added."))];
                    case 9:
                        _b.sent();
                        _b.label = 10;
